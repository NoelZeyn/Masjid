    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex-1 p-8 pt-4 bg-white">
            ...
            <div class="flex-grow w-full p-8">
                <div
                    class="bg-white border border-gray-300 rounded-lg shadow-sm overflow-hidden"
                >
                    <div
                        class="flex justify-between items-center px-5 py-3 border-b border-gray-300"
                    >
                    ...
                    <div class="p-4 md:p-6">
                        <h4
                            class="text-center text-base font-medium text-gray-900 mb-6"
                        >
                            Informasi Profil
                        </h4>
                        ...
                        <div class="space-y-4">
                            <div
                                class="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-5"
                            >
                                <label
                                    class="md:w-[150px] font-bold text-sm text-gray-900"
                                    >Nama Lengkap</label
                                >
                                <input
                                    type="text"
                            ...
                            >
                                <label
                                    class="md:w-[125px] font-bold text-sm text-gray-900"
                                    >Ubah Password</label
                                >
                                <router-link
                                    to="/ubah-password"
