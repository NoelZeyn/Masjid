    ...
    <div class="flex-1 p-8 pt-4 bg-white">
      ...
      <div class="my-4 border-b border-gray-300"></div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-300 mt-6">
                <div class="p-8">
                    <h3 class="text-lg font-bold text-gray-900 pb-4 border-b border-gray-300">Ubah Password</h3>
                    ...
                    <form @submit.prevent="submitPassword" class="space-y-4 mt-5">
                        ...
                        <div class="flex justify-between mt-8">
                            <button type="button" class="cursor-pointer px-8 py-2 text-white bg-[#074a5d] border border-[#074a5d] rounded-full font-medium hover:bg-gray-100 hover:text-black focus:outline-none focus:ring-2 focus:ring-[#074a5d]" @click="handleBack">
                                Batal
                            </button>
                            <button type="submit"
