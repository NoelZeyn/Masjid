      ...
      <div class="w-[80%] max-w-[450px] text-center">
        ...
        <form @submit.prevent="register">
          <div class="flex flex-col items-start mb-5">
            <label class="text-base mb-1 font-bold">Nama Lengkap</label>
            <div class="relative w-full">
              <img :src="informIcon" alt="Info Icon"
                class="absolute right-[10px] top-1/2 transform -translate-y-1/2 w-5 h-5" />
              <input type="text" v-model="form.nama_lengkap" placeholder="Masukkan nama anda" required
          ...
          <div class="flex flex-col items-start mb-5">
            ...
            <select v-model="form.posisi" required :class="{ 'text-gray-400': form.posisi === '' }"
          ...
          <div class="flex flex-col items-start mb-5">
            ...
            <input type="file" @change="onFileChange('foto_ktp', $event)" accept="image/*" required
              class="w-full p-3 border border-gray-300 rounded-[10px] text-base" />
          </div>

          <div class="flex flex-col items-start mb-5">
            <label class="text-base mb-1 font-bold">Foto Profil</label>
            <input type="file" @change="onFileChange('foto_profil', $event)" accept="image/*" required
              class="w-full p-3 border border-gray-300 rounded-[10px] text-base" />
          </div>
...
export default {
  ...
  methods: {
    ...
    async register() {
      ...
      if (!email || !password) {
        this.message = "Email atau password tidak ditemukan. Silakan ulangi proses pendaftaran.";
      ...
      try {
        ...
        this.message = error.response?.data?.message || "Terjadi kesalahan saat mendaftar.";
        this.messageClass = "text-red-500";
      }
    },
  },
